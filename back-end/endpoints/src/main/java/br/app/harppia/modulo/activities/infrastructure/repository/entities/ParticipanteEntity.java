...
@Getter
@Setter
@ToString(of = {"id", "updatedBy", "participacaoConfirmada", "idAtividade"})
...
public class ParticipanteEntity {
	...
	@Column(name = "participacao_confirmada", insertable = false)
	...
	@Column(name = "s_church_t_tb_instrumento_ass_usuario_c_funcao", nullable = false, updatable = false)
