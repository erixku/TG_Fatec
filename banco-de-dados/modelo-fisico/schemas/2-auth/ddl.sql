...
CREATE TABLE auth.tb_usuario (
  ...
  -- dados do usuário
  status                 utils.s_auth_t_tb_usuario_e_status NOT NULL DEFAULT 'em verificação',
  cpf                    VARCHAR(11)                            NULL,
  ...
  is_email_verificado    BOOLEAN                            NOT NULL DEFAULT FALSE,
  telefone               VARCHAR(11)                            NULL,
  is_telefone_verificado BOOLEAN                            NOT NULL DEFAULT FALSE,
