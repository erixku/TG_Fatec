...
public enum NomeBucket implements EnumPersistivel {
	FOTO_PERFIL_USUARIO("foto-perfil-usuario"), FOTO_PERFIL_IGREJA("foto-perfil-igreja"),
	FOTO_PERFIL_MINISTERIO("foto-perfil-ministerio"), ICONE_INSTRUMENTO("icone-instrumento"), AUDIO("audio"),
	PDF("pdf"), SISTEMA_ICONE_INSTRUMENTO("sistema-icone-instrumento"), SISTEMA_IMAGEM("sistema-imagem"),
