...
public abstract class UsuarioMapper {
	 ...
	 * nos campos <b>`nome`</b> e <b>`sobrenome`</b> (entidade).
...
//		else 
//			throw new IllegalArgumentException("Falha ao mapear: o sobrenome não pode ser nulo!");
//			
//	}
//	
	/**
	 * Método para, após a conversão do DTO para entidade, converter o campo <b>`nomeSocialCompleto`</b> (DTO)
	 * nos campos <b>`nomeSocial`</b> e <b>`sobrenomeSocial`</b> (entidade).
	 * @param usuario o destino de onde será salvo o nome e sobrenome
	 * @param userDTO de onde virá os dados do nome completo
	 */
//	@AfterMapping
