        ...
        <View className="bg-slate-50 dark:bg-slate-700 rounded-xl p-4 shadow-xl" >
            <DateTimePicker
                ...
                classNames={{
                    ...
                    month_label: 'text-slate-900/40 dark:text-blue-100/60',
                    month_selector: 'p-2 rounded-xl mr-1 bg-slate-50 dark:bg-slate-700',
                    month_selector_label: 'text-slate-900 dark:text-blue-100',
                    selected_month_label: 'text-slate-900 dark:text-blue-100 border-b border-indigo-700 dark:border-indigo-300',
                    year_label: 'text-slate-900/40 dark:text-blue-100/60',
                    year_selector: 'p-2 rounded-xl bg-slate-50 dark:bg-slate-700',
                    year_selector_label: 'text-slate-900 dark:text-blue-100',
                    selected_year_label: 'text-slate-900 dark:text-blue-100 border-b border-indigo-700 dark:border-indigo-300',
                    header: 'rounded-xl bg-slate-200 dark:bg-slate-800',
                }}
                locale="pt"
