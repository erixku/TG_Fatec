...
import { ProfileSettingsFormData } from "@/app/homeMenu/profileSettings";

export default function ProfileSettingsForm() {
    const [modalVisible, setModalVisible] = useState<boolean>(false);
    const { control, formState: {errors}, setValue } = useFormContext<ProfileSettingsFormData>();
                ...
                render={({field, fieldState}) => (
                    <View className="items-center w-full mb-4 gap-y-5">
                        ...
                        <PhotoPicker 
                            ...
                            onChange={(asset) => {
                                if (asset) {
                                    const fileInfo: ProfileSettingsFormData["arquivo"] = {
                                        caminho: asset.uri,
